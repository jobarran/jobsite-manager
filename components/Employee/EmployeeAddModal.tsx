...
interface Props {
    ...
    setIsEmployeeMutating: any
}

export const EmployeeAddModal:FC<Props> = ({ openEmployeeModal, handleCloseEmployeeModal, setIsEmployeeMutating}) => {
